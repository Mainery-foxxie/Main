        ...
        Create("Frame", {
            ...
            Create("UIGradient", {
                ...
                Transparency = NumberSequence.new({
                    NumberSequenceKeypoint.new(0, 0.795, 0), 
                    NumberSequenceKeypoint.new(0.295, 1, 0), 
        ...
        function comp1:AddSection(secTitle)
            ...
            function components:AddButton(buttonTitle, tooltip, callback)
                ...
                b1.MouseButton1Click:Connect(function()
                    ...
                    if not btndebounce then
                        btndebounce = true
                        TweenService:Create(b1:FindFirstChildOfClass("UIStroke"), TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out, 0, true), {Color = window.AccentColor}):Play()
                        wait(0.4)
                        btndebounce = false
                    end
                end)
            ...
            function components:AddToggle(buttonTitle, tooltip, default, callback)
                ...
                b1.MouseButton1Click:Connect(function()
                    ...
                    callback(t1.State)
                    TweenService:Create(toggle.ImageLabel, TweenInfo.new(t1.State and 0.3 or 0.8, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = t1.State and UDim2.new(0, 20, 0, 20) or UDim2.new(0, 0, 0, 0)}):Play()
