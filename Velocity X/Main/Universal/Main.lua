-- Load the library
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mainery-foxxie/Main/refs/heads/main/UI%20Libary/Xova%20UI/source.lua"))() -- Replace with actual path

-- Create the main window
local Window = Library:Window({
    Title = "UGC Limited Sniper",  -- Your window title
    SubTitle = "Made by Velocity X"  -- Your subtitle
})

-- Create a new page
local MainPage = Window:NewPage({
    Title = "Main",  -- Page title
    Desc = "Automatic Claim",  -- Page description
